...
class WiresTest {
	...
	void testPart2() throws Exception {
		Assertions.assertEquals(43848, Wires.fewestStepToIntersection(wireA, wireB));
	}

	@Test
	void testFewestStepToIntersection0() {
		Assertions.assertEquals(30, Wires.fewestStepToIntersection(
				"R8,U5,L5,D3",
				"U7,R6,D4,L4"));
	}

	@Test
	void testFewestStepToIntersection1() {
		Assertions.assertEquals(610, Wires.fewestStepToIntersection(
				"R75,D30,R83,U83,L12,D49,R71,U7,L72",
				"U62,R66,U55,R34,D71,R55,D58,R83"));
	}

	@Test
	void testFewestStepToIntersection2() {
		Assertions.assertEquals(410, Wires.fewestStepToIntersection(
				"R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51",
				"U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"));
	}
